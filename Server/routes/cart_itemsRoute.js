...
import { getAllCartItems1,getCartItemsOfCart1, getCartItem1, createCartItem1, updateCartItem1, deleteCartItem1 } from '../controllers/cart_itemsController.js';

const router = express.Router();

// Define routes
router.get('/', getAllCartItems1); // Get all cart items
router.get('/:cart_id', getCartItemsOfCart1); // Get all cart items   
